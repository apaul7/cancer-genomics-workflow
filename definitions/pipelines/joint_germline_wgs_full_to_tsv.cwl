...
cwlVersion: v1.0
class: Workflow
label: "joint wgs alignment and germline variant detection to annotated vcf+tsv"
requirements:
...
steps:
    ...
    joint_detect_variants:
        ...
        in:
            ...
            sv_manta_call_regions: sv_manta_call_regions
        ...
        out:
            [snps_results, sv_results, str_results, filtered_snps_vcf]

    annotate_and_gnomad_filter:
        run: ../subworkflows/joint_annotate_and_filter.cwl
        in:
            vcf: joint_detect_variants/filtered_snps_vcf
            reference: reference
            vep_cache_dir: vep_cache_dir
            vep_ensembl_assembly: vep_ensembl_assembly
            vep_ensembl_version: vep_ensembl_version
